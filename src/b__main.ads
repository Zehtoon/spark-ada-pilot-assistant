...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#ca2c37fd#;
   ...
   u00121 : constant Version_32 := 16#9e774b9b#;
   pragma Export (C, u00121, "aircraft_typesS");
   u00122 : constant Version_32 := 16#2cc296e2#;
   pragma Export (C, u00122, "as_io_wrapperB");
   u00123 : constant Version_32 := 16#2503c2be#;
   pragma Export (C, u00123, "as_io_wrapperS");
   ...
   u00131 : constant Version_32 := 16#ba001e29#;
   pragma Export (C, u00131, "system__img_biuS");
   u00132 : constant Version_32 := 16#f75ed9f7#;
   pragma Export (C, u00132, "system__img_llbS");
   u00133 : constant Version_32 := 16#98c6c945#;
   pragma Export (C, u00133, "system__img_lliS");
   u00134 : constant Version_32 := 16#80af2c85#;
   pragma Export (C, u00134, "system__img_lllbS");
   u00135 : constant Version_32 := 16#f316ccbd#;
   pragma Export (C, u00135, "system__img_llliS");
   u00136 : constant Version_32 := 16#8adb3589#;
   pragma Export (C, u00136, "system__img_lllwS");
   u00137 : constant Version_32 := 16#ab6cacfc#;
   pragma Export (C, u00137, "system__img_llwS");
   u00138 : constant Version_32 := 16#85daa51b#;
   pragma Export (C, u00138, "system__img_wiuS");
   u00139 : constant Version_32 := 16#236b2bc2#;
   pragma Export (C, u00139, "system__val_intS");
   u00140 : constant Version_32 := 16#28959a26#;
   pragma Export (C, u00140, "system__val_unsS");
   u00141 : constant Version_32 := 16#6e5eba19#;
   pragma Export (C, u00141, "system__val_llliS");
   u00142 : constant Version_32 := 16#750441df#;
   pragma Export (C, u00142, "system__val_llluS");
   u00143 : constant Version_32 := 16#3fa394d3#;
   pragma Export (C, u00143, "showstatsB");
   u00144 : constant Version_32 := 16#79497dd7#;
   pragma Export (C, u00144, "showstatsS");
   u00145 : constant Version_32 := 16#3b57eb3a#;
   pragma Export (C, u00145, "aircraft_statusB");
   u00146 : constant Version_32 := 16#0c51433a#;
   pragma Export (C, u00146, "aircraft_statusS");
   u00147 : constant Version_32 := 16#8a416c03#;
   pragma Export (C, u00147, "altitudeB");
   u00148 : constant Version_32 := 16#cc8d4a16#;
   pragma Export (C, u00148, "altitudeS");
   u00149 : constant Version_32 := 16#04504c70#;
   pragma Export (C, u00149, "displaystatsB");
   u00150 : constant Version_32 := 16#d2899199#;
   pragma Export (C, u00150, "displaystatsS");
   u00151 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00151, "system__concat_2B");
   u00152 : constant Version_32 := 16#a07a41cd#;
   pragma Export (C, u00152, "system__concat_2S");
   u00153 : constant Version_32 := 16#a160e120#;
   pragma Export (C, u00153, "engine_controlB");
   u00154 : constant Version_32 := 16#ca9a5a50#;
   pragma Export (C, u00154, "engine_controlS");
   u00155 : constant Version_32 := 16#1b36f2b3#;
   pragma Export (C, u00155, "flight_controlB");
   u00156 : constant Version_32 := 16#77227c48#;
   pragma Export (C, u00156, "flight_controlS");
   u00157 : constant Version_32 := 16#005b8789#;
   pragma Export (C, u00157, "selectdestinationB");
   u00158 : constant Version_32 := 16#f6afcedf#;
   pragma Export (C, u00158, "selectdestinationS");
   ...
   u00161 : constant Version_32 := 16#e9046dda#;
   pragma Export (C, u00161, "system__img_fltS");
   u00162 : constant Version_32 := 16#61e84971#;
   pragma Export (C, u00162, "system__fat_fltS");
   u00163 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00163, "system__float_controlB");
   u00164 : constant Version_32 := 16#4226d521#;
   pragma Export (C, u00164, "system__float_controlS");
   u00165 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00165, "system__img_utilB");
   u00166 : constant Version_32 := 16#c9a0e932#;
   pragma Export (C, u00166, "system__img_utilS");
   u00167 : constant Version_32 := 16#e42d37a4#;
   pragma Export (C, u00167, "system__powten_fltS");
   u00168 : constant Version_32 := 16#13a3b932#;
   pragma Export (C, u00168, "speedB");
   u00169 : constant Version_32 := 16#9776167e#;
   pragma Export (C, u00169, "speedS");
